...
const styles = {
    ...
    sentimentTag: (sentiment) => ({
        fontSize: '10px',
        fontFamily: "'JetBrains Mono', monospace",
        color: sentiment >= 0.65 ? '#22c55e' : sentiment <= 0.3 ? '#ef4444' : '#f59e0b',
        background: sentiment >= 0.65 ? 'rgba(34,197,94,0.1)' : sentiment <= 0.3 ? 'rgba(239,68,68,0.1)' : 'rgba(245,158,11,0.1)',
        padding: '2px 7px',
        borderRadius: '3px'
    }),
    noEvents: {
