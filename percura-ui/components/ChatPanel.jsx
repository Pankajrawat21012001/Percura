        ...
        <div className="flex flex-col h-full bg-[#0D0D0D] border-l border-white/5 shadow-2xl relative">
            ...
            <div className="p-6 border-b border-white/5 bg-black/40 backdrop-blur-xl relative z-50">
                <div className="flex items-center justify-between mb-6">
                    <h2 className="text-[10px] uppercase tracking-[0.4em] text-white/40 font-black">Audience Dialogue</h2>
                    <button
                        onClick={onClose}
                        ...
                        <div key={m.id || idx} className={`flex flex-col ${m.sender === "user" ? "items-end" : "items-start underline-none"} ${m.sender === "system" ? "w-full items-center py-4" : ""}`}>
                            {m.sender !== "system" && (
                                <div className="flex items-center gap-2 mb-2 px-1">
                                    ...
                                    <span className="text-[9px] uppercase tracking-widest text-white/30 font-bold">{m.senderName}</span>
                                </div>
                            )}
                            <div className={`
                                ...
                                ${m.sender === "user"
                                    ...
                                    : m.sender === "system"
                                        ? "text-[10px] text-white/20 italic px-8 py-2 border-y border-white/5 w-full text-center bg-white/[0.01]"
                    ...
                    {loading && (
                        <div className="flex flex-col items-start animate-in fade-in duration-300">
                            <div className="flex items-center gap-2 mb-2 px-1">
                                ...
                                <span className="text-[9px] uppercase tracking-widest text-white/30 font-bold">Audience is thinking...</span>
                            </div>
            ...
            <div className="p-6 border-t border-white/5 bg-black/20">
                ...
                {!isBlocked && rateLimitCounter >= 3 && (
                    <p className="text-[9px] text-amber-400/60 font-medium mb-3 text-center uppercase tracking-widest">
